...
bool paperFace::generateCutoutSheet(ofstream* dxfFile, VektorR2 offset, VektorR2 dir, int start_with_index, 
				    ...
				    bool allow_intersection, bool allow_to_split = false)
{
  ...
  if(optimal_face->writeToDXF(dxfFile, offset, dir, start_with_index, 
  ...
  do {
	...
	return true;
      ...
      //                  Actually this is why the son has been
      //                  chosen above.
...
bool paperFace::writeToDXF(ofstream* DXFFile, VektorR2 offset, VektorR2 dir, int start_with_index, 
