...
public:
  ...
  bool     writeToDXF(ofstream*, VektorR2, VektorR2, int, VektorR2, int, bool, bool);  
  ...
  bool     generateCutoutSheet(ofstream*, VektorR2, VektorR2, int, VektorR2, int, double, bool, bool);
